...
if [ $stage -le 5 ]; then
  ...
  relu-batchnorm-layer name=tdnn6 dim=512 input=stats #changed the dim from 512 to 256. as xvector_nnet1a/extract.config has tdnn 6 as the output layer.
...
dropout_schedule='0,0@0.1,0.05@0.10,0'
srand=123
if [ $stage -le 6 ]; then
